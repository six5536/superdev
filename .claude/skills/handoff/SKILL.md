...
<step name="REFERENCE ARTIFACTS" task="Reference artifacts instead of duplicating them: a spec, plan, ADR, issue, commit, or diff is cited by path or id, not copied in" />
