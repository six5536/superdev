---
type: Issue
id: issue-023-a-concept-path-written-outside-the-knowledge-is-checked-by-nothing
...
- When a file the grammar governs names a concept path that resolves to
  no concept, the validator reports the file and the path, at the
  severity the same finding carries inside the knowledge.

## Scope

The check alone, over the files the grammar already walks.
