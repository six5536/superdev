...
- At `turn_end`, remaining validation findings appear in a separate visible Pi follow-up. The follow-up is bounded, contains paths and corrective actions without patches or mutation envelopes, and triggers the main agent to make targeted corrections.
