---
type: Issue
id: issue-046-audit-the-one-directional-drift-bindings
...
links:
  ...
  - rel: references
    to: issue-045-drift-tests-bind-what-the-contract-declares
...
The audit reaches three bindings in two test files.
