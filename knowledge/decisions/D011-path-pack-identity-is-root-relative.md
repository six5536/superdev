...
[The spec](../specs/S014-content-packs-design.md) lets a pack come from a
directory on this machine.
[ADR-004](D004-base-pack-identity.md) settled that a source is compared on a
...
the embedded content — the failure [ADR-004](D004-base-pack-identity.md) calls
...
- Negative: `identity` grows a parameter that a git source does not use, and
  ...
  which does.
- Follow-ups: [C001](../contracts/C001-content-packs.md) states a path
