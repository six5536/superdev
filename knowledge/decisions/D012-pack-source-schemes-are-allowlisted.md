...
`[[packs]].source` is handed to `git clone` as the URL. [S014](../specs/S014-content-packs-design.md) makes naming
a source the user's trust decision; it says nothing about the transport that
source is reached over.
[ADR-004](D004-base-pack-identity.md) makes the comparison key deliberately
...
- Follow-ups: [C001](../contracts/C001-content-packs.md) gains
