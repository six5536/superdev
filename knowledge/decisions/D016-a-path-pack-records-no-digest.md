...
promise [S014](../specs/S014-content-packs-design.md) makes: the next run proves it got the same bytes the pin was
...
- Follow-ups: [C001](../contracts/C001-content-packs.md) carries the new
