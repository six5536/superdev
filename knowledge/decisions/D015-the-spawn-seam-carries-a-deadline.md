...
`CommandRunner` is the one process boundary in the codebase — [S014](../specs/S014-content-packs-design.md) fetches
...
for. [ADR-009](D009-update-queries-default-source.md) changed it: `update`
...
- Follow-ups: [C001](../contracts/C001-content-packs.md) records the seam
