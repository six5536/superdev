...
[Externally sourced content packs][sokf:contract-007-interface-pack-resolution]
layers content by item, and [ADR-003][sokf:adr-003-items-by-layout] reads an item's
identity out of the pack tree. [The
contract][sokf:contract-007-interface-pack-resolution] wrote the knowledge-skeleton kind
