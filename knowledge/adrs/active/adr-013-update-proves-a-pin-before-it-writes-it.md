...
[C007][sokf:contract-007-interface-pack-resolution] gives a pack a `format` and has a binary refuse one it does not know.
...
- Follow-ups: [contract-002-cli-superdev][sokf:contract-002-cli-superdev] states what `update`
  guarantees about the pin it saves; [C007][sokf:contract-007-interface-pack-resolution]
