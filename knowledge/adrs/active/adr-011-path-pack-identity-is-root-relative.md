...
[The pack-resolution contract][sokf:contract-007-interface-pack-resolution] lets a pack come from a
...
- Negative: `identity` grows a parameter that a git source does not use, and
  ...
  which does.
- Follow-ups: [C007][sokf:contract-007-interface-pack-resolution] states a path
