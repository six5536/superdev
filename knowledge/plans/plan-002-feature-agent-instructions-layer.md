...
### Slice 1: prefactor — ensure-line append note

the engine's ensure-line
...
### Slice 2: entry-point restructure (knowledge)

the aokf component stops
...
and aokf.md.
### Slice 3: codegraph agent wiring

the codegraph component plans
...
### Slice 4: dogfood and knowledge upkeep

enable `[code-index]` in this
