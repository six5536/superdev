...
| FR-12 | issue-021-backport-the-knowledge-design-to-the-pack names the pack files this plan leaves stale | O4 |
...
3. Add the drift to the backport's record — this plan leaves
   ...
   issue-021-backport-the-knowledge-design-to-the-pack owns
...
| `knowledge/issues/issue-021-backport-the-knowledge-design-to-the-pack.md` | modified — this plan's pack drift added to its surfaces | W6 |
...
- `knowledge/schemas/adhoc-plan.md`'s worked example carries
  ...
  it. Four more schemas carried the same fault, all left by the same
  filename-convention migration; the five ids were corrected by hand and
  the missing check is
  [I022][sokf:issue-022-a-schemas-worked-example-is-checked-by-nothing].
- [I012][sokf:issue-012-five-decidable-findings-only-warn]
  asks for the same promotion W5 performs. W5 does not close it; the five
...
| Target | Form | Example |
|--------|------|---------|
| A concept | reference link labelled `sokf:<id>` | `[the schemas do not ship][sokf:issue-020-the-schemas-do-not-ship]` |
...
```markdown
<!-- sokf:links -->
[sokf:issue-020-the-schemas-do-not-ship]: /knowledge/issues/issue-020-the-schemas-do-not-ship.md
```
