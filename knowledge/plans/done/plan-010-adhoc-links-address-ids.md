...
- `check_links` reaching the grammar's roots, so a concept path written
  ...
  tomorrow's. Filed as
  [I023][sokf:issue-023-feature-request-a-concept-path-written-outside-the-knowledge-is-checked-by-nothing].
...
- [I012][sokf:issue-012-feature-request-five-decidable-findings-only-warn]
