...
* [Workflows Provider Default](2026-08-17-workflows-provider-default-design.md) - design for defaulting workflows to mattpocock-skills as materialised repo files, with superpowers as a supported plugin-based secondary.
