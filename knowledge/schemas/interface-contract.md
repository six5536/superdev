---
type: Schema
id: schema-interface-contract
title: Interface Contract Schema
description: The interfaces build codes against — data model, module boundaries, key flows — filed in knowledge/contracts/.
---

# Interface Contract Schema

Structural rules for interface contracts filed at
`knowledge/contracts/contract-{feature-slug}.md`. Build codes against it;
