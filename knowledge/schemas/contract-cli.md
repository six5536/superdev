...
description: One command-line surface — its commands, their behaviour, the exit codes and the stability promise, in knowledge/contracts/public/.
---

# CLI Contract Schema

Structural rules for one public command-line contract, filed at
`knowledge/contracts/public/contract-{nnn}-cli-{slug}.md`. One document per binary: a project shipping two
