...
description: One RPC service — its IDL, transport, authentication, error codes and stability promise, in knowledge/contracts/public/.
---

# RPC Contract Schema

Structural rules for one public RPC contract, filed at
`knowledge/contracts/public/contract-{nnn}-rpc-{slug}.md`. gRPC, Thrift, Cap'n Proto or JSON-RPC: the
