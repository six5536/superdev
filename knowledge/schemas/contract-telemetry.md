...
description: The signal operators build on — the metrics, the log shape, the traces, and the stability promise, in knowledge/contracts/public/.
---

# Telemetry Contract Schema

Structural rules for one public telemetry contract, filed at
`knowledge/contracts/public/contract-{nnn}-telemetry-{slug}.md`. Metric names, label sets and log fields are a
