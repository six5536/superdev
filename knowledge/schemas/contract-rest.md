...
description: One HTTP API — its endpoints in TypeSpec, the authentication, the error responses and the stability promise, in knowledge/contracts/public/.
---

# REST Contract Schema

Structural rules for one public HTTP contract, filed at
`knowledge/contracts/public/contract-{nnn}-rest-{slug}.md`. The endpoints are defined in TypeSpec, which is
