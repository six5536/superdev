...
id: schema-chore
title: Chore Schema
description: Scoped mechanical work filed in knowledge/issues/ — the surfaces it touches and what done means, with no room for a root cause it does not have.
---
...
frontmatter:
  ...
  status:
    ...
    description: >
      draft while the work is outstanding; the resolution rides in tags,
      not here.
...
sections:
  ...
  - heading-pattern: "^(Decided|Resolved|Resolved in part|Won't fix|Comments)$"
    ...
    content: prose
    description: >
      How the work ended, added when it does: what shipped and where, or
      why it was dropped. Absent while the work is outstanding, which is
      what distinguishes an open chore from a settled one at a glance.

example: |
  ---
  type: Chore
  id: issue-042-drop-the-legacy-cache-directory
