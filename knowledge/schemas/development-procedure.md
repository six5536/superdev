...
Structural rules for `knowledge/development-procedure.md`, the bundle's
...
sections:
  - heading: "Workflow"
    ...
    description: >
      ...
      commit conventions, slice size; how the knowledgebase is kept current
...
example: |
  ...
  3. When behaviour or design changes, the bundle concept that describes it
