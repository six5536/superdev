...
description: The user-facing surface — its routes, its screens and their states, the platforms supported, and the stability promise, in knowledge/contracts/public/.
---

# UI Contract Schema

Structural rules for one public user-interface contract, filed at
`knowledge/contracts/public/contract-{nnn}-ui-{slug}.md`. The standing surface a user or a link depends
