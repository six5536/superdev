...
* [Domain Glossary](glossary.md) - the terms the blueprint engine uses — blueprint, capability, provider, component, owned file, scaffold, skill pack, PROJECT.md layer, custom skill — plus the search terms section, locator, hybrid search and RRF.
