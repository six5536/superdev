...
repo's stranded facts into the canonical knowledge at `knowledge/` and interview
the owner for the rest.

A harvest relocates one durable fact from a source into the canonical knowledge,
...
- [ ] Inventory every prose document in the repo: README,
      ...
      predate superdev. Skip generated files and the canonical knowledge itself.
...
- [ ] Harvest source by source: split each into passages. Knowledge
      ...
      derive from the environment) lands in the canonical knowledge; environment
...
- [ ] Incumbent entry point? Ask the owner: merge and reduce (durable
      content into the canonical knowledge, always-loaded rules into `AGENTS.md`,
...
- The canonical knowledge, filled and PASSing.
