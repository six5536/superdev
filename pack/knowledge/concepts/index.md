...
* [Coding Standards][sokf:coding-standards] - TBD — the conventions code and prose in this repository follow.
* [Security Requirements][sokf:security-requirements] - TBD — the security posture — threat surfaces, handling rules, and the vulnerability policy.
* [Dependency Policy][sokf:dependency-policy] - TBD — when a dependency may be added and how its version is chosen.
