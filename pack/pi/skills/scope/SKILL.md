...
5. Only after explicit confirmation, use SOKF-aware `write` or `edit` to author either missing record. The LLM chooses each valid, collision-free ID and all semantic content. Keep issue and plan IDs independent.
